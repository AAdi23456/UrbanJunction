document.addEventListener('DOMContentLoaded', function () {
  ...
  const category_filter=document.getElementById("category-filter")
    const url = "https://gifted-tights-yak.cyclic.app/products/show/?category=shoes&page=1";
  ...
  const sorting=document.getElementById("price-sort")
    ...
    prevButton.disabled=false
      fetch(`https://gifted-tights-yak.cyclic.app/products/show/?category=shoes&page=${page}`)
            ...
            .then(async data => {
              ...
              MappingtheResponse(data);
              let newpage=page
              const nextres=await fetch(`https://gifted-tights-yak.cyclic.app/products/show/?category=shoes&page=${newpage++}`)
  ...
  let debouncer;
    ...
    function filterCards(searchValue,filterByBrand,sort) {
       ...
       if(sort){
        ...
        const filteredUrl = `https://gifted-tights-yak.cyclic.app/products/show?category=shoes&${queryString}`;
