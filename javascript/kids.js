document.addEventListener('DOMContentLoaded', function () {
  ...
  const category_filter=document.getElementById("category-filter")
    const url = "https://gifted-tights-yak.cyclic.app/products/show/?category=kids&page=1";
    ...
    prevButton.disabled=false
      fetch(`https://gifted-tights-yak.cyclic.app/products/show/?category=men&page=${page}`)
            ...
            .then(async data => {
              ...
              MappingtheResponse(data);
              let newpage=page
              const nextres=await fetch(`https://gifted-tights-yak.cyclic.app/products/show/?category=kids&page=${newpage++}`)
    ...
    prevButton.addEventListener("click",function(e){
     // e.preventDefault()
      ...
      nextButton.disabled=false
        ...
        fetch(`https://gifted-tights-yak.cyclic.app/products/show/?category=kids&page=${page}`)
              .then(response => {
                  if (!response.ok) {
                      throw new Error('Network response was not OK');
                  }
  ...
  let debouncer;
    ...
    function filterCards(searchValue,filterByBrand,sort) {
       ...
       if(sort){
        ...
        const filteredUrl = `https://gifted-tights-yak.cyclic.app/products/show?category=kids&${queryString}`;
